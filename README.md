...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
   ReactJS is a frontend framework that helps to resolve problems with building web applications such as routing, modularizing code, and ux experience such as not having to refresh a page everytime you change pages.

1. Describe component state.
   A component state is a place where you can store data about a component and have it persist during a user's session.

1. Describe props.
   Props are like attributes on html tags. They are used to pass data between components.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
   Side effects are things that happen outside of a function. They can be things like console logs, xhr requests, or event listeners. You use the second argument of useEffect to sync slices of state and props.
